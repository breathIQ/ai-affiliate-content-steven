        ...
        try {
            ...
            $data = $posts->getCollection()->map(function ($post) {
                ...
                return [
                    ...
                    'chapter_code' => preg_replace('/^CHAPTER\s+/i', 'Ch-', $post->chapter?->chapter) ?? preg_replace('/^CHAPTER\s+/i', 'Ch-', $post->chapter_title),
        ...
        try {
            ...
            $data = [
                ...
                'chapter' => [
                    ...
                    'chapter' => preg_replace('/^CHAPTER\s+/i', 'Ch-', $post->chapter?->chapter) ?? preg_replace('/^CHAPTER\s+/i', 'Ch-', $post->chapter_title),
                ],
